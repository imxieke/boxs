# Generated by Powerlevel10k configuration wizard on 2021-12-05 at 15:14 CST.
...
() {
  ...
  if [[ $POWERLEVEL9K_MULTILINE_FIRST_PROMPT_GAP_CHAR != ' ' ]]; then
    ...
    # typeset -g POWERLEVEL9K_MULTILINE_FIRST_PROMPT_GAP_FOREGROUND=yellow
  ...
  #
  #   # Styling for WORK.
    # typeset -g POWERLEVEL9K_DIR_HOME_BACKGROUND="yellow"
